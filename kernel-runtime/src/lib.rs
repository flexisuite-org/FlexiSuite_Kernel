...
pub struct Permissions {
    pub network_allowlist: Vec<String>, // URL prefixes or domains
}

#[async_trait]
pub trait SandboxRuntime {
    async fn execute(&mut self, code: &str, input: serde_json::Value) -> Result<serde_json::Value, SandboxError>;
}
